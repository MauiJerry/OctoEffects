 ...
 * modified by Jerry Isdale for inclusion in NeoEffects as part of OctoStrip
 *
...
This implementation is designed for use with the NeoPixel Library, but should be easily modifiable to be used in other contexts. The hsl() function returns a 32 bit, packed RGB value, exaclty the same as OctoWS2811::Color().
 ...
 */
uint32_t OctoStrip::hsl(uint16_t ih, uint8_t is, uint8_t il) {
 ...
 * Helper function
 */
uint8_t OctoStrip::hsl_convert(float c, float t1, float t2) {
