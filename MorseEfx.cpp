...
void OctoWindow::printMorseCurState()
{
...
void OctoWindow::setMorseEfx(uint32_t dotTime, uint32_t color, String msg, int repeatCount)
{
  ...
  curUpdateFunc = (OctoWindowUpdateFunc) &OctoWindow::morseEffectUpdate;

}

void OctoWindow::morseEffectUpdate(void)
{ 
